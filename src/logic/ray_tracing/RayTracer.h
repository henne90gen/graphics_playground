...
struct Object {
    ...
    // float transparency = 0.0F; TODO add this back in
...
void rayTrace(const std::vector<Object> &objects, const Light &light, const glm::vec3 &cameraPosition, float zDistance,
              std::vector<glm::vec3> &pixels, unsigned int width, unsigned int height, unsigned int maxRayDepth,
...
Object sphere(const glm::vec3 &position, const glm::vec3 &color, float radius, float reflection = 0.0F);
