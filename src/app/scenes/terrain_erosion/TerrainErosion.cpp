...
void TerrainErosion::generateTerrainMesh(TerrainData &terrainData, const std::vector<glm::vec2> &vertices,
    ...
    terrainData.normals = std::vector<glm::vec3>(vertices.size());
