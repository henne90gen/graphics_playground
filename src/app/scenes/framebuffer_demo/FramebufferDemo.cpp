...
void FramebufferDemo::setup() {
    ...
    mirrorVA = createQuadVA(shader, true);
...
void FramebufferDemo::tick() {
    ...
    static glm::vec3 mirrorPosition = {1.7F, 0.0F, -1.0F};
        static glm::vec3 mirrorRotation = {0.0F, 1.4F, 0.0F};
//    static glm::vec3 mirrorRotation = {-0.22F, 2.65F, 0.12F};
    ...
    glm::vec3 mirrorCameraPosition = {mirrorPosition.x, -1.0F * mirrorPosition.y, mirrorPosition.z};
    glm::vec3 normal = {1.0F, 0.0F, 0.0F};

    glm::mat4 mirrorRotationMatrix = glm::rotate(glm::mat4(1.0F), mirrorRotation.x, glm::vec3(1, 0, 0));
    mirrorRotationMatrix = glm::rotate(mirrorRotationMatrix, -1.0F * mirrorRotation.y, glm::vec3(0, 1, 0));
    mirrorRotationMatrix = glm::rotate(mirrorRotationMatrix, mirrorRotation.z, glm::vec3(0, 0, 1));
    normal = mirrorRotationMatrix * glm::vec4(normal, 0.0F);
    glm::vec3 mirrorUp = mirrorRotationMatrix * glm::vec4(0.0F, 1.0F, 0.0F, 0.0F);

    glm::vec3 mirrorCameraDirection = glm::normalize(glm::reflect(cameraPosition - mirrorPosition, normal));
