...
#define FRONT_CUBES {24, 25, 26, 21, 22, 23, 18, 19, 20}
#define BACK_CUBES { 8, 7, 6, 5, 4, 3, 2, 1, 0}
#define RIGHT_CUBES {26, 17, 8, 23, 14, 5, 20, 11, 2}
#define LEFT_CUBES {6, 15, 24, 3, 12, 21, 0, 9, 18}
#define UP_CUBES {6, 7, 8, 15, 16, 17, 24, 25, 26}
#define DOWN_CUBES {18, 19, 20, 9, 10, 11, 0, 1, 2}
...
#define R_D {Face::DOWN, Direction::CLOCKWISE}
#define R_DI {Face::DOWN, Direction::COUNTER_CLOCKWISE}
#define R_L {Face::LEFT, Direction::CLOCKWISE}
#define R_LI {Face::LEFT, Direction::COUNTER_CLOCKWISE}
#define R_U {Face::UP, Direction::CLOCKWISE}
#define R_UI {Face::UP, Direction::COUNTER_CLOCKWISE}
