...
void Sky::init() { shader = CREATE_DEFAULT_SHADER(landscape_Sky); }
...
void Sky::updateAndRender(const std::shared_ptr<VertexArray> &cubeVA, const glm::mat4 &projectionMatrix,
