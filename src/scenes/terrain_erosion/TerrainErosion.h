...
class TerrainErosion : public Scene {
  ...
  private:
    ...
    void regenerateRaindrops(const glm::ivec2 &terrainSize, std::vector<Raindrop> &raindrops,
                             ...
                             float radius);
    void showSettings(glm::vec3 &modelScale, glm::vec3 &modelRotation, glm::vec3 &cameraPosition, glm::vec3 &cameraRotation, glm::vec3 &lightPos,
    ...
    void runSimulation(const glm::ivec2 &terrainSize, TerrainData &terrainData,
